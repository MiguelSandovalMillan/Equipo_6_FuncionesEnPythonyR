...
author: "Miguel Sandoval, Juan Carrillo, Aldo Hernandez, Rosendo Hernandez"
format: 
    html:
      toc: TRUE
    pdf:
...
# Creacion de la Funcion con Condicional  (Valor Final)
...
```{r}
interesSimple = function(va = NULL, r = NULL, n = NULL, VF = NULL) { # Ponemos por default
   parametros = list(va = va, r = r, n = n, VF = VF)  # Creamos una lista
